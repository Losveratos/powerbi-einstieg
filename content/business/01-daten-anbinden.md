...
> Lösch die Abfrage rechts (Rechtsklick auf **verkaeufe_2025** → **Aus Bericht
> löschen**) und fang bei Schritt 1 neu an.
>
> Geht es gar nicht? Lade die Datei stattdessen herunter
> ([verkaeufe_2025.csv](https://github.com/Losveratos/powerbi-einstieg/releases/latest/download/verkaeufe_2025.csv)) und binde sie über
