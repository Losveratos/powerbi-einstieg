...
hält. Alle fünf reparieren wir jetzt — mit **{{schritte}} Handgriffen**.
...
> Ganz unten steht: **{{tabellen_name}} ({{zeilen}} Zeilen)**.
> Die Tabelle hat **{{spalten}} Spalten** mit richtigen Namen, und in der Spalte
...
>
> Oder: [Checkpoint-Datei laden]({{checkpoint_geputzt}}) und mit Modul 3
